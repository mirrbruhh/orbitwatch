...
print("  • Hardware Baselines:")
print("      - Chemical (300s): ISRO Liquid Apogee Motor (LAM) / SpaceX Draco.")
print("      - Hall (1800s): ISRO GSAT-9 EPS / Safran PPS.")
print("      - Ion (3000s): Gridded Ion Thrusters (Boeing XIPS, NASA NSTAR).")
print("      - Plasma (1200s): Bellatrix Aerospace 'JAL' targets (~4x chemical).")
